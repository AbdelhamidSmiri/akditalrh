...
.stat-en-cours { color: #ffc107; }
.stat-valider { color: #17a2b8; }
.stat-checkin { color: #28a745; }
.stat-checkout { color: #6c757d; }
.stat-annuler { color: #dc3545; }
.stat-occupation { color: #007bff; }
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <h1 class="title-page">Dashboard Appartement</h1>
        <span class="slogan">Analyse complète et gestion des bénéficiaires</span>
    </div>
