...
<div class="container" style="max-width: 600px; margin: auto;">
    ...
    <?php if ($fin != 'ok') { ?>
        <div class="mt-5">
            <h3 class="title-condition">Conditions d’occupation du logement – Akdital</h3>
            <p class="text-cond">
            ...
            <label class="control control--checkbox">Je m'engage à respecter les lieux, le mobilier et les règles de vie de l’appartement.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>
            <label class="control control--checkbox">Je suis responsable des clés et du matériel mis à disposition.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>
            <label class="control control--checkbox">Je m'engage à informer l’agence en cas de problème ou dégradation.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>
            <label class="control control--checkbox">Je quitterai le logement à la date prévue ou après accord de prolongation.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>
            <label class="control control--checkbox">Je m'engage à restituer les lieux dans un état propre et conforme.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>

            <label class="control control--checkbox">Je ne suis pas autorisé à héberger d’autres personnes sans validation préalable.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>

            <label class="control control--checkbox">Je m'engage à signaler mon départ via WhatsApp ou à l’agence.
                <input type="checkbox" checked disabled />
                <div class="control__indicator"></div>
            </label>
            ...
            <div class="checkbox" style="margin-bottom: 20px;">
                <label class="control control--checkbox">J’ai compris et j’accepte les conditions
                    <input type="checkbox" name="valide" required />
                    <div class="control__indicator"></div>
                </label>
            </div>
            <div class="div_btn-sub">
                <button type="submit" class="btn btn-success-rounded p-2 px-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <h3 class="title-text mt-lg-5">
                        Votre demande a bien été confirmée avec succès.
                    </h3>
                    <p class="sub-text">La demande est maintenant en cours de traitement.</p>
